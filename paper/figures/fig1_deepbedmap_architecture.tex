...
\node[canvas is xy plane at z=0] (temp) at (-1.8,3,0){
    \includegraphics[width=2cm,height=2cm]{paper/figures/fig1a_bedmap2.png}
};

\node[canvas is xy plane at z=0] (temp) at (-1.6,0,0){
    \includegraphics[width=2cm,height=2cm]{paper/figures/fig1b_rema.png}
};

\node[canvas is xy plane at z=0] (temp) at (-1.8,-3.5,0){
    \includegraphics[width=2cm,height=2cm]{paper/figures/fig1c_measures.png}
};

\node[canvas is xy plane at z=0] (temp) at (-1.8,-5.5,0){
    \includegraphics[width=2cm,height=2cm]{paper/figures/fig1d_accumulation.png}
};

\pic[shift={ (1.0,0,0) }] at (-1.2,3,0){
    Box={
        name=x0_img,
        caption= ,
        xlabel={ 1, },
...
\pic[shift={ (1.0,0,0) }] at (-1.2,-3.5,0){
    Box={
        name=w2_img,
        caption= ,
        xlabel={ 1, },
...
\pic[shift={ (1.0,0,0) }] at (-1.2,-5.5,0){
    Box={
        name=w3_img,
        caption= ,
        xlabel={ 1, },
...
\pic[shift={ (0,-1.5,0) }] at (w3_img-west)
    {Box={
...
\node[canvas is xy plane at z=0] (temp) at (21,0,0){
    \includegraphics[width=5cm,height=5cm]{paper/figures/fig1e_deepbedmap.png}
};
...
\pic[shift={ (3,-2.4,0) }] at (deepbedmap-dem-east)
    {Box={
        name=key,
        caption=Key:,
        fill=\PoolColor,
...
\pic[shift={(-1.2,-1.6,0)}] at (key-southwest)
    {Box={
        name=conv,
...
\pic[shift={ (0,-2,0) }] at (conv-southwest){
    Box={
        name=upsample,
        caption=NN\\Upsample,
        xlabel={ 64, },
